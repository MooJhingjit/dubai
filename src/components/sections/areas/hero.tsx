    ...
    <div className="w-full h-[calc(100vh-80px)] relative">
      ...
      <div className="relative z-30 h-full flex items-center max-w-md px-4 py-10 mx-auto sm:max-w-7xl sm:px-6 lg:px-8 xl:px-0 md:py-16">
        ...
        <div className="text-center   sm:text-left">
          {/* Heading */}
          <h1
            className="font-romain  text-4xl sm:text-6xl md:text-7xl  text-[#F7F9FC] mb-5"
            style={{
              lineHeight: "1.5"
            }}
          >
          ...
          {/* Subheading */}
          <p className="font-suisse text-lg md:text-2xl mb-20 sm:mb-9 text-[#F7F9FC] max-w-[900px]">
            {t("subTitle")}
          </p>
          <p className="font-suisse text-lg md:text-2xl mb-20 sm:mb-9 text-[#F7F9FC] max-w-[900px]">
            {t("secondSubTitle")}
